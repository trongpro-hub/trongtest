...
if World3 then
    ...
    RaceV4:Seperator("gạt cần")
    
    RaceV4:Button("bay lên đỉnh cây", function()
        topos(CFrame.new(2952.8408203125, 2281.97900390625, -7216.93701171875))
    end)
    
    RaceV4:Button("xoá sương", function()
        game:GetService("Lighting").LightingLayers:Destroy()
        game:GetService("Lighting").Sky:Destroy()
    end)

    RaceV4:Button("tele đến npc ở pháo đài", function()
    ...
    RaceV4:Toggle("bay đến đảo bí ẩn", _G.AutoMysticIsland, true, function(value)
        _G.AutoMysticIsland = value
        StopTween(_G.AutoMysticIsland)
        _G.AutoDooHee = value
    end)
    
    RaceV4:Toggle("Tween Gear", _G.TweenMGear, false, function(value)
        _G.TweenMGear = value
        StopTween(_G.TweenMGear)
    end)
    
    RaceV4:Toggle("Auto Look Moon", _G.AutoDooHee false, function(v)
        _G.AutoDooHee = v
    end)
    
    RaceV4:Toggle("Auto Active Race V3", _G.AutoAgility, true, function(value)
...
RaceV4:Button("Rejoin Server", function()
    game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
end)

RaceV4:Button("Server Hop", function()
    while wait() do
...
JobAiDee = RaceV4:Label("Server Job ID : ")

RaceV4:Button("Copy Server Job ID", function()
...
SRaceV4:Seperator("Advance Fruit Stock")
