do local GUI = game.CoreGui:FindFirstChild("Pixel Hub");if GUI then GUI:Destroy();end;if _G.Color == Color3.fromRGB(0, 255, 255) then
...
function Update:Window(text,logo,keybind)
 ...
 PIXELHUB.Name = "Pixel Hub"
 PIXELHUB.Parent = game.CoreGui
 PIXELHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
 
 local Main = Instance.new("ImageLabel")
 Main.Name = "Main"
 Main.Parent = PIXELHUB
 ...
 Main.Active = true
 Main.Draggable = true
 Main.Image = "rbxassetid://13755223840"
 ...
 --Logo.Image = "rbxassetid://13755190794"
...
Exe.Name = "Name"
Exe.Parent = Top
Exe.BackgroundColor3 = Color3.fromRGB(224,224,224)
Exe.BackgroundTransparency = 1.000
Exe.Position = UDim2.new(0.3009756112, 0, 0, 0)
Exe.Size = UDim2.new(0, 61, 0, 27)
Exe.Font = Enum.Font.GothamBold
Exe.Text = "Executor :"..executor
...
Player.Name = "Name"
Player.Parent = Top
Player.BackgroundColor3 = Color3.fromRGB(224,224,224)
Player.BackgroundTransparency = 1.000
Player.Position = UDim2.new(0.5009756112, 0, 0, 0)
Player.Size = UDim2.new(0, 61, 0, 27)
Player.Font = Enum.Font.GothamBold
Player.Text = "Players :"..game.Players.NumPlayers
...
ServerTime.Position = UDim2.new(0.677561002, 0, 0, 0)
...
game:GetService("RunService").RenderStepped:Wait()
 ...
 Page.BackgroundTransparency = 0.8
 ...
 function uitab:Tab(text,icon)
	 ...
	 function main:Toggle(text,config,callback)
		 ...
		 Circle.BackgroundColor3 = Color3.fromRGB(227, 255, 255)
...
person.ImageRectSize = Vector2.new(36, 36)
	 ...
	 function main:Slider(text,min,max,set,callback)
		 ...
		 HAHA.Name = "HAHA"
		 HAHA.Parent = sliderr
		 HAHA.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
	 ...
	 function main:Textbox(text,disappear,callback)
		 ...
		 Textboxx.BackgroundTransparency = 0.8
		 ...
		 for i,v in next, game:GetService('Players'):GetPlayers() do
			 if v.Name ~= game:GetService('Players').LocalPlayer.Name then
				 pcall(function()
					 ...
					 v.Character.HumanoidRootPart.Color = Color3.fromHSV(tick() * 24 % 255/255, 1, 1)
...
Closed.Font = Enum.Font.Creepster
Closed.Text = "P"
Closed.TextColor3 = Color3.fromRGB(0, 255, 255)
Closed.TextScaled = true
Closed.TextSize = 16.000
--Closed.Image = "https://www.roblox.com/headshot-thumbnail/image?userId="..game.Players.LocalPlayer.UserId.."&width=420&height=420&format=png"
...
local Library = Update:Window("Pixel Hub","",Enum.KeyCode.RightControl);
...
Main:Seperator("Infomation")
Main:Label("Made By Nguyễn Như Hải")
...
Main:Textbox("Speed Hack", speed, function(speed)
 game:GetService("Players").LocalPlayer.Character.Humanoid.WalkSpeed = speed
end)

Main:Textbox("Jump Hack", jump, function(jump)
 game:GetService("Players").LocalPlayer.Character.Humanoid.JumpPower = jump
end)

Main:Textbox("Fov", fov, function(fov)
 game.Workspace.CurrentCamera.FieldOfView = fov
end)

bringfrec = 1000
Main:Textbox('Bring Mob', value, function(value)
bringfrec = value
end)
...
Main:Textbox("Distance", a, function(a)
 DisFarm = a
end)
...
game:GetService("RunService").Heartbeat:Connect(function()
 if AutoFarmHeart or AutoFarmNearestMob or _G.BossRaid or _G.GrabChest or AutoCitizen or AutoEcto or AutoEvoRace or AutoBartilo or AutoFactory or BringChestz or BringFruitz or _G.Auto_Farm_Level or _G.Clip2 or _G.Auto_Farm_Level or _G.BlackBeard or _G.BlackBeardHop or AutoFarmBone or _G.BlackBeard or AutoFarmSelectMonsterQuest or AutoFarmSelectMonsterNoQuest or AutoFarmBossNoQuest or AutoFarmBossQuest or _G.d or AutoFarmMasGun or AutoFarmMasDevilFruit or AutoFarmSelectArea or AutoSecondSea or AutoThirdSea or _G.Mirage or AutoDeathStep or AutoSuperhuman or AutoSharkman or AutoElectricClaw or AutoDragonTalon or AutoGodhuman or AutoRengoku or AutoBuddySword or AutoPole or AutoHallowSycthe or AutoCavander or AutoTushita or AutoDarkDagger or AutoCakePrince or _G.Auto_Open_Dough_Dungeon or _G.Auto_Open_Dough_King or _G.Auto_Spawn_Cake_Prince or AutoEliteHunter or AutoRainbowHaki or AutoSaber or AutoFarmKen or AutoKenHop or AutoKenV2 or KillPlayerMelee or KillPlayerGun or KillPlayerFruit or AutoDungeon or AutoNextIsland or AutoAdvanceDungeon or Musketeer or RipIndra or Auto_Serpent_Bow or AutoTorch or AutoSoulGuitar or Auto_Cursed_Dual_Katana or AutoFarmMaterial or Auto_Quest_Yama_1 or Auto_Quest_Yama_2 or Auto_Quest_Yama_3 or Auto_Quest_Tushita_1 or Auto_Quest_Tushita_2 or Auto_Quest_Tushita_3 or _G.Factory or _G.SwanGlasses or AutoBartilo or AutoEvoRace or AutoEcto then
...
pcall(function()
 while wait() do
 if AutoFarmHeart or AutoFarmNearestMob or _G.BossRaid or _G.GrabChest or AutoCitizen or AutoEcto or AutoEvoRace or AutoBartilo or AutoFactory or BringChestz or BringFruitz or _G.d or _G.Auto_Farm_Level or _G.Clip2 or _G.Auto_Farm_Level or _G.BlackBeard or _G.BlackBeardHop or AutoFarmBone or _G.BlackBeard or AutoFarmSelectMonsterQuest or AutoFarmSelectMonsterNoQuest or AutoFarmBossNoQuest or AutoFarmBossQuest or AutoFarmMasGun or AutoFarmMasDevilFruit or AutoFarmSelectArea or AutoSecondSea or AutoThirdSea or AutoDeathStep or AutoSuperhuman or AutoSharkman or AutoElectricClaw or AutoDragonTalon or AutoGodhuman or AutoRengoku or AutoBuddySword or AutoPole or AutoHallowSycthe or AutoCavander or AutoTushita or AutoDarkDagger or AutoCakePrince or _G.Auto_Open_Dough_Dungeon or _G.Auto_Open_Dough_King or _G.Auto_Spawn_Cake_Prince or AutoEliteHunter or AutoRainbowHaki or AutoSaber or AutoFarmKen or _G.Mirage or AutoKenHop or AutoKenV2 or KillPlayerMelee or KillPlayerGun or KillPlayerFruit or AutoDungeon or AutoNextIsland or AutoAdvanceDungeon or Musketeer or RipIndra or Auto_Serpent_Bow or AutoTorch or AutoSoulGuitar or Auto_Cursed_Dual_Katana or AutoFarmMaterial or Auto_Quest_Yama_1 or Auto_Quest_Yama_2 or Auto_Quest_Yama_3 or Auto_Quest_Tushita_1 or Auto_Quest_Tushita_2 or Auto_Quest_Tushita_3 or _G.Factory or _G.SwanGlasses or AutoBartilo or AutoEvoRace or AutoEcto then
...
pcall(function()
 game:GetService("RunService").Stepped:Connect(function()
   if AutoFarmHeart or AutoFarmNearestMob or _G.BossRaid or _G.GrabChest or AutoCitizen or AutoEcto or AutoEvoRace or AutoBartilo or AutoFactory or BringChestz or BringFruitz or _G.Auto_Farm_Level or _G.Clip2 or _G.Auto_Farm_Level or _G.BlackBeard or _G.BlackBeardHop or AutoFarmBone or _G.BlackBeard or AutoFarmSelectMonsterQuest or _G.Mirage or AutoFarmSelectMonsterNoQuest or AutoFarmBossNoQuest or AutoFarmBossQuest or AutoFarmMasGun or AutoFarmMasDevilFruit or AutoFarmSelectArea or AutoSecondSea or AutoThirdSea or AutoDeathStep or AutoSuperhuman or AutoSharkman or AutoElectricClaw or AutoDragonTalon or AutoGodhuman or AutoRengoku or AutoBuddySword or AutoPole or AutoHallowSycthe or AutoCavander or AutoTushita or AutoDarkDagger or AutoCakePrince or _G.Auto_Open_Dough_Dungeon or _G.Auto_Open_Dough_King or _G.Auto_Spawn_Cake_Prince or AutoEliteHunter or AutoRainbowHaki or AutoSaber or AutoFarmKen or AutoKenHop or AutoKenV2 or _G.d or KillPlayerMelee or KillPlayerGun or KillPlayerFruit or AutoDungeon or AutoNextIsland or AutoAdvanceDungeon or Musketeer or RipIndra or Auto_Serpent_Bow or AutoTorch or AutoSoulGuitar or Auto_Cursed_Dual_Katana or AutoFarmMaterial or Auto_Quest_Yama_1 or Auto_Quest_Yama_2 or Auto_Quest_Yama_3 or Auto_Quest_Tushita_1 or Auto_Quest_Tushita_2 or Auto_Quest_Tushita_3 or _G.Factory or _G.SwanGlasses or AutoBartilo or AutoEvoRace or AutoEcto then
...
Main:Toggle("Anti Cheat Bypasss", true, function(value)
_G.SafeFarm = value
CheckAntiCheatBypass()
end)
...
if World2 then
 ...
 Farm:Seperator("Dark Coat")

 local BlackBeardStatus = Farm:Label("Status : N/Q")
 ...
 Farm:Toggle("Auto Dark Coat", _G.BlackBeard,function(value)
	 _G.BlackBeard = value
	 CancelTween(_G.BlackBeard)
 end)
 
 Farm:Toggle("Auto Dark Coat Hop", false, function(value)
	 Hop()
 end)
		 ...
		 if _G.BlackBeard then
			 pcall(function()
				 ...
				 elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fist of Darkness") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fist of Darkness") then
					 repeat Tween(CFrame.new(3777.564697265625, 14.876824378967285, -3499.460205078125)) wait() until (CFrame.new(3777.564697265625, 14.876824378967285, -3499.460205078125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 8                        
				 else
					 if game:GetService("ReplicatedStorage"):FindFirstChild("Darkbeard [Lv. 1000] [Raid Boss]") then
						 Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Darkbeard [Lv. 1000] [Raid Boss]").HumanoidRootPart.CFrame * CFrame.new(5,10,7))
					 else
						 if _G.BlackBeard then
							 Hop()
						 end
...
pcall(function()
 ...
 CakePrinceStatus:Set("Killed : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39)..' / 500')
   ...
   CakePrinceStatus:Set("Cake Prince : No Spawned.")
 end
 end)
end
end)
...
Farm:Toggle("Auto Spawn Cake Prince",_G.Auto_Spawn_Cake_Prince,function(value)
	 ...
	 spawn(function()
		 while wait() do
			 if _G.Auto_Spawn_Cake_Prince then
				 ...
				 game:GetService("-").Remotes.CommF_:InvokeServer(unpack(args))
			 end
		 end
	 end)

Farm:Toggle("Auto Open Dough Dungeon",_G.Auto_Open_Dough_Dungeon,function(value)
_G.Auto_Open_Dough_Dungeon = value
CancelTween(_G.Auto_Open_Dough_Dungeon)
end)
...
Farm:Toggle("Auto Dough King",_G.Auto_Open_Dough_King,function(value)
_G.Auto_Open_Dough_King = value
 CancelTween(_G.Auto_Open_Dough_King)
end)

 spawn(function()
	 while wait() do
		 if _G.Auto_Open_Dough_King then
			 pcall(function()
				 if game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice") then
					 if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SweetChaliceNpc"),"Where") then
					 else
							 ...
							 for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do  
								 if (v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Cookie Crafter [Lv. 2200]") and v.Humanoid.Health > 0 then
									 repeat wait()
										 ...
										 game:GetService'VirtualUser':CaptureController()
										 game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
									 until _G.Auto_Open_Dough_King == false or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or not v.Parent or v.Humanoid.Health <= 0
								 end
							 end
						 else
							 Tween(CFrame.new(-1820.0634765625, 210.74781799316406, -12297.49609375))
						 ...
						 for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do 
							 if v.Name == "Dough King [Lv. 2300] [Raid Boss]" then
								 repeat wait()
									 ...
									 game:GetService'VirtualUser':CaptureController()
									 game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
								 until _G.Auto_Open_Dough_King == false or not v.Parent or v.Humanoid.Health <= 0
							 end    
						 end    
					 else
						 Tween(CFrame.new(-2009.2802734375, 4532.97216796875, -14937.3076171875)) 
									 ...
									 if v.Name == "Diablo [Lv. 1750]" or v.Name == "Deandre [Lv. 1750]" or v.Name == "Urban [Lv. 1750]" then
										 if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
											 repeat wait()
												 ...
												 game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
												 sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
											 until _G.Auto_Open_Dough_King == false or v.Humanoid.Health <= 0 or not v.Parent or game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice")
										 end
									 end
								 end
							 else
	 ...
	 while task.wait(.1) do
		 pcall(function()
			 ...
			 if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
				 BosstElite:Set("Elite Hunter : Spawned.")
			 else
				 BosstElite:Set("Elite Hunter : No Spawned.")
			 end
		 end)
	 end
 end)
...
Farm:Seperator("Rip Indra")

Farm:Toggle('Auto Rip Indra', AutoDarkDagger, function(autodarkdaggerfunc)
...
Farm:Toggle('Auto Rip Indra [HOP]', false, function(value)
Hop()
end)
...
Combat:Seperator("Hit Box")

Combat:Toggle("Hit Box",_G.Disabled,function(value)
_G.Disabled = value
end)
...
Combat:Dropdown("Hit Box Size", HitSize,function(value)
 HitBoxSize = value
end)
spawn(function()
 while wait(.1) do
	 if HitBoxSize == "20" then
		 _G.HeadSize = 20
	 elseif HitBoxSize == "50" then
		 _G.HeadSize = 50
	 elseif HitBoxSize == "80" then
		 _G.HeadSize = 80
	 end
 end
end)
...
Combat:Dropdown("Hit Box Transparent", HitTrans,function(value)
 HitBoxTrans = value
end)
spawn(function()
 while wait(.1) do
	 if HitBoxTrans == "20%" then
		 _G.Trans = 25
	 elseif HitBoxTrans == "50%" then
		 _G.Trans = 50
	 elseif HitBoxTrans == "80%" then
		 _G.Trans = 80
	 end
 end
end)
...
spawn(function()
 ...
 Mirragecheck:Set('🏝️ : Mirage Island : Found ✅️')
 else
   Mirragecheck:Set('🏝️ : Mirage Island : Not Found ❎️')
		 end
	 end
 end)
end)
...
Teleport:Toggle("Remove Fog",RemoveFog,function(value)
	 RemoveFog = value
...
game.StarterGui:SetCore("SendNotification", {
	 Title = "PixelHub"; -- the title (ofc)
	 Text = "Mirage not Found!"; -- what the text says (ofc)
	 Icon = "rbxassetid://13438920682"; -- the image if u want. 
...
elseif World3 then
 ...
 Teleport:Button("Mansion",function()
	 game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12553.8125, 332.403961, -7621.91748))
			 ...
			 if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
				 for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
					 if v.Name == "Island 5" and (v.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 2300 then
						 Tween(v.CFrame*CFrame.new(0,70,100))
					 end
				 end
			 elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") then
				 for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
...
if World2 then
	 Dungeon:Toggle("TP Flower Red",function()
		 for i,v in pairs(game.Workspace:GetDescendants()) do
	 ...
	 Dungeon:Toggle("TP Flower Blue",function()
		 for i,v in pairs(game.Workspace:GetDescendants()) do
		 ...
		 if not isnil(v.Character) then
			 if ESPPlayer then
				 if not isnil(v.Character.Head) and not v.Character.Head:FindFirstChild('NameEsp'..Number) then
					 ...
					 HealthESP.Font = Enum.Font.SourceSansSemibold
					 ...
					 HealthESP.Position = UDim2.new(0, 0, 0, 15)
					 HealthESP.Size = UDim2.new(0, 200, 0, 30)
					 HealthESP.TextYAlignment = 'Top'
					 HealthESP.BackgroundTransparency = 1
					 HealthESP.TextStrokeTransparency = 0.5
					 HealthESP.TextColor3 = Color3.fromRGB(0, 255, 0)
					 HealthESP.TextSize = 13
				 else
					 v.Character.Head['NameEsp'..Number].ESP.Text = (v.Name ..' '..round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Character.Head.Position).Magnitude/3) ..' Distance')
					 v.Character.Head['NameEsp'..Number].ESP.HealthESP.Text = "Health "..math.floor(v.Character.Humanoid.Health).."/"..math.floor(v.Character.Humanoid.MaxHealth)
				 end
			 else
...
v:FindFirstChild('NameEsp'):Destroy()
 ...
 Dungeon:Toggle("ESP Real Fruit",false,function(a)
	 RealFruitESP = a
 ...
 Dungeon:Toggle("ESP Island",false,function(a)
	 IslandESP = a
...
Shop:Button("Random Race (Use 3K Fragments)", function()
 ...
 Misc:Button("Copy You Job-Id",function()
 setclipboard(tostring(game.JobId))
 end)
 
 Misc:Textbox("Paste Your Job-Id Here", Jobid, function(Jobid)
 ...
 Misc:Button("Destroy Ui",function()
	 if game.CoreGui:FindFirstChild("PIXELHUB") then
		 game.CoreGui:FindFirstChild("PIXELHUB"):Destroy()
		 game.CoreGui:FindFirstChild("PIXELHUB"):Destroy()
	 end
 end)
...
RaceV4:Toggle("Auto Complete Ghoul Trial",AutoGhoul,function(value)
AutoGhoul = value  
end)
		 ...
		 for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
			 if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
				 pcall(function()
					 ...
					 until not AutoCom  or not v.Parent or v.Humanoid.Health <= 0
				 end)
			 end
		 end
	 end
...
RaceV4:Toggle("Auto Complete Human Trial",AutoHuman,function(value)
AutoHuman = value  
end)
